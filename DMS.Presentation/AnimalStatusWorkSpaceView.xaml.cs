...
namespace DMS.Presentation
{
    ...
    /// </summary>
    public partial class AnimalStatusWorkSpaceView : UserControl, IWorkSpaceViewControl
    {

        AnimalInsemnationsHandler animalInsemnationHandler;

        public AnimalStatusWorkSpaceView()
        {
            InitializeComponent();
        }
		...
		public void Refresh()
		{
            datagridAnimalInsemnation.ItemsSource = new AnimalsHandler().GetAnimals_All_WithStatuses();
		}
